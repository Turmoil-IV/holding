...
export function Cta27() {
  return (
    <section id="relume" className="relative px-[5%] py-16 md:py-24 lg:py-28 bg-deepSapphire-lightest">
      <div className="relative z-10 container max-w-lg text-center">
        ...
        <p className="text-text-alternative md:text-md">
          Discover how you can partner with us to shape the future of technology
          investments.
        </p>
